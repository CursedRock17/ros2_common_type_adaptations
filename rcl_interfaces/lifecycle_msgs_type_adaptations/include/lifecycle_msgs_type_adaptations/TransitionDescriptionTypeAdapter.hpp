#ifndef LIFECYCLE_MSGS_TYPE_ADAPTATIONS__TRANSITIONDESCRIPTIONTYPEADAPTER_HPP_
#define LIFECYCLE_MSGS_TYPE_ADAPTATIONS__TRANSITIONDESCRIPTIONTYPEADAPTER_HPP_
...
struct CustomTransitionDescription
{
...
template<>
struct rclcpp::TypeAdapter<CustomTransitionDescription, lifecycle_msgs::msg::TransitionDescription>
{
  using is_specialized = std::true_type;
  using custom_type = CustomTransitionDescription;
  using ros_message_type = lifecycle_msgs::msg::TransitionDescription;
...
#endif  // LIFECYCLE_MSGS_TYPE_ADAPTATIONS__TRANSITIONDESCRIPTIONTYPEADAPTER_HPP_
